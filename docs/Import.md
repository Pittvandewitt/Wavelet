...
[AutoEq.app](https://autoeq.app){ .md-button .md-button--primary } [Squig.link](https://squig.link){ .md-button .md-button--primary }  
...
Files imported in Wavelet are normalized. This is done so that the perceived volume stays the same. It also prevents mistakes from blowing your ears out, for example when a typo is made where a 5.5db boost mistakenly becomes a 55db boost.
